...
export default function useAuthorization() {
  ...
  async function setUsername(newUsername: string) {
    ...
    axios
      .put(
        `${API}/user/setUsername?newUsername=${newUsername}`,
  ...
  async function getMyInventory() {
    return await axios
      .get(`${API}/inventory/getUserInventory`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getSelectInventory() {
    return await axios
      .get(`${API}/inventory/getSelectItem`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getDetailProduct(product_id: any) {
    return await axios
      .get(`${API}/inventory/getInventoryById?id=${product_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function deleteMyProduct(product_id: any) {
    return await axios
      .delete(`${API}/inventory/deleteInventoryById?id=${product_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function postMyReqeust(dataArray: any | undefined) {
    ...
    return await axios
      .post(`${API}/user/newRequest`, dataArray, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
          "Content-Type": "application/json",
        },
  ...
  async function deleteMyRequestPending(requestpending_id: any) {
    ...
    // show("โหลดดิ้ง..");
    return await axios
      .delete(`${API}/user/cancelRequest?id=${requestpending_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getAnotherUser(user_id: any) {
    // show("โหลดดิ้ง..");
    return await axios
      .get(`${API}/user/searchID?id=${user_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getFollowCheck(user_id: any) {
    // show();
    return await axios
      .get(`${API}/user/checkFollow?id=${user_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getUserFollowData(user_id: any) {
    return await axios
      .get(`${API}/user/getFollowById?id=${user_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function LockRequest(request_id: any, product_id: any) {
    return await axios
      .patch(
        `${API}/user/lockRequest`,
        { id: request_id, inventoryId: product_id },
        {
          headers: {
            Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
            "Content-Type": "application/json",
  ...
  async function deleteMyLockRequestPending(requestpending_id: any) {
    ...
    return await axios
      .patch(
        `${API}/user/cancelLockRequest`,
        { id: requestpending_id },
        {
          headers: {
            Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
            "Content-Type": "application/json",
  ...
  async function getSearch(searchword: any) {
    return await axios
      .get(`${API}/inventory/search?query=${searchword}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getAnotherInventory(user_id: any) {
    // show("โหลดดิ้ง..");
    return await axios
      .get(`${API}/inventory/getInventoryByUserId?id=${user_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getMatchProduct(product_id: any) {
    // show("โหลดดิ้ง..");
    return await axios
      .get(`${API}/inventory/getMatchInventory?id=${product_id}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function getDealingList(userId: string): Promise<IDealing[] | null> {
    // show()
    return await axios
      .get(`${API}/user/getDealing?id=${userId}`, {
        headers: {
          Authorization: `Bearer ${cookies.DaveTheHornyDuck}`,
        },
      })
  ...
  async function searchByCategory(parentCateEn: any, childCateEn: any) {
    if (childCateEn != "none") {
      return await axios
        .post(
          `${API}/inventory/searchByCategory`,
          {
