export default function ProductPost({onBgClick , photoLink}:any) {
    return (
        <div className="position-fixed " style={{zIndex:99,top:"0",bottom:"0",right:"0",left:"0"}}>
            ...
            <div className="product-post-content position-relative bg-dark"  style={{maxWidth:"700px",height:"auto",margin:"auto",marginTop:"100px"}}>
                <img className="d-block" src={photoLink} style={{maxWidth:"100%",maxHeight:"calc(100vh-300px)"}}/>
            </div>
        </div>
    );
}