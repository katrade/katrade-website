...
const th = [
  ...
  "ยืนยัน",
  "ยืนยันอีเมลของคุณ",
  "ลิงค์เปลี่ยนรหัสผ่านของคุณถูกส่งไปที่",
...
const en = [
  ...
  "Confirm",
  "Verify Your Email",
  "Veryfy link is sent to",
  "Please setting new password.",
  "Setting Your New Password",
  "New Password",
  ...
  "Confirm",
  "Successfull Setting Your New Password",
...
export function ResetPasswordForm() {
  ...
  const submitResetPass = (password: string, confirmPassword: string) => {
    if (password === confirmPassword) {
      ...
      axios
        .patch(`${API}/auth/resetPassword`, { password: password }, config)
        .then((response) => {
      ...
      >
        ...
        >
          ...
          <SolidButton
            ...
            padding="5px"
            margin="0"
            onClick={() => submitResetPass(password, confirmPassword)}
          >
            {content[12]}
          </SolidButton>
        </Div>
