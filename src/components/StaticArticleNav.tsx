      ...
      >
        <div className="row m-0 p-0 full-width">
          <div className="col-auto p-0 d-flex align-items-center my-3">
            ...
            />
            <span style={ArticleStyle}>| Articles</span>
          </div>
          <div
            className={
              "col p-0 d-flex align-items-center my-3 justify-content-end"
            }
          >
            <LanguageSelector />
            <Icon
              src={theme === "dark" ? moon : sunrise}
              width="30px"
              onClick={toggleTheme}
            />
          </div>
  ...
  return (
    <div className={theme === "light" ? "dropdown" : "dropdown-dark"}>
      <button className={theme === "light" ? "dropbtn" : "dropbtn-dark"}>
        ...
        {lang === "en" ? (
          <>
            <img src={en} width="20" className="mx-2" />
            EN
          </>
        ) : (
          <>
            <img src={th} width="20" className="mx-2" />
            TH
          </>
        )}{" "}
      </button>
      <div
        className={
          theme === "light" ? "dropdown-content" : "dropdown-content-dark"
        }
      >
        <a onClick={() => preToggleLanguage("en")}>
          <img src={en} width="20" className="mx-2" />
          EN
        </a>
        <a onClick={() => preToggleLanguage("th")}>
          <img src={th} width="20" className="mx-2" />
          TH
        </a>
      </div>
