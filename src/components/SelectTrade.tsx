...
export default function SelectTrade({
  ...
  const listMatchInventory = arrayMatch.map((data: any, index: any) => {
    return (
      ...
      >
        <p className="m-0 px-3 me-1" style={{ color: "#000", fontWeight: 500 }}>
          {data.name}
        </p>
        <p
          className="m-0 px-3 me-1"
          style={{ color: "#999ba1", fontWeight: 400, fontSize: "16px" }}
        >
          {data.detail}
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="cardMobile position-relative bg-white rounded-3 py-1"
        style={{
          height: "auto",
          margin: "auto",
          marginTop: "100px",
          boxShadow: "0 0 20px rgba(10,10,10,0.3)",
        }}
      >
        <div
          className="m-0 p-0 rounded-top full-width d-flex justify-content-center align-items-center"
          style={{ backgroundColor: "#fff", height: "70px" }}
        >
          <p className="m-0" style={{ fontWeight: 500, color: "#000" }}>
            <CgShoppingBag className="me-2" />
            Select your item
          </p>
        </div>
        <div
          className="row m-0 mx-3"
        ...
        >
          ...
          <div
            className={
              handleSelected == 1
                ? "col select-items-menu p-0 currenttap"
                : "col select-items-menu p-0"
            }
            onClick={() => {
              setHandleTrade(listMatchInventory);
              setHandleSelected(1);
            }}
          >
          ...
          <div
            ...
            onClick={() => {
              setHandleTrade(listMyInventory);
              setHandleSelected(2);
            }}
          >
