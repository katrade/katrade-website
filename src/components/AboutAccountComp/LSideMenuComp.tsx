...
function LSideMenuComp(props: any) {
  ...
  return (
    <div>
      <P className="d-flex align-items-center fs-4 fw-bold mb-0">
        <BsPersonFill />
        &nbsp;&nbsp;My Account
      </P>
      <div className="mb-3 ms-4">
        <P
          className="pointer"
          onClick={(e: any) => sendDestComp(e.currentTarget.innerHTML)}
      ...
      <P
        onClick={(e: any) => sendDestComp("Favorite")}
        className="d-flex align-items-center fs-4 fw-bold mb-3 pointer"
      >
        <BsStarFill />
        &nbsp;&nbsp;My Favorite
      </P>
      <P
        onClick={(e: any) => sendDestComp("Inventory")}
        className="d-flex align-items-center fs-4 fw-bold mb-3 pointer"
      >
        <BsBagFill />
        &nbsp;&nbsp;Inventory
      ...
      <P
        onClick={(e: any) => sendDestComp("History")}
        className="d-flex align-items-center fs-4 fw-bold mb-3 pointer"
      >
        <BiHistory />
        &nbsp;&nbsp;History
