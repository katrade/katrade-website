  ...
  return (
    <>
      <Background>
        ...
        >
          <HeadTab>
            <h3 className="white">Our developers</h3>
          </HeadTab>
          <div className="my-5" />
  ...
  return (
    <>
      <div className="col-lg m-0 p-4 d-flex">
        <Embed
          style={{ backgroundColor: theme === "light" ? "#f2f4f7" : "#2a2c2e" }}
        >
          ...
          />
          <Icon
            src={instagramForDark}
            onClick={() => (window.location.href = `${ig}`)}
            width="30px"
          />
          <Icon
            src={theme === "light" ? github : githubForDark}
...
function ProfilePlaceHolder() {
  return (
    <>
      <div className="col-lg m-0 p-4"></div>
    </>
  );
}
