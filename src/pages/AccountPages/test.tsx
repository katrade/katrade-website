...
export default function AddItem() {
  ...
  SubCategoriesEn.push([
    {
      value: "กรุณาเลือก Category หลักก่อน",
      label: "กรุณาเลือก Category หลักก่อน",
    },
  ]);
  ...
  var [godHelpMe, setGodHelpMe] = useState<any>(
    <Select
  ...
  function selectedSub(index: any, event: any) {
    const values = [...wantInputFields];
    var sub = event.indexC;
    values[index]["reqCat"]["childCategoryEn"] = event.value;
    // console.log(SubCateLangTh[0][wantSubCateIndex][sub]);
    values[index]["reqCat"]["childCategoryTh"] =
      SubCateLangTh[0][wantSubCateIndex][sub];
    SetWantInputFields(values);
  }
        ...
        <form onSubmit={handleUnload}>
          <div className="p-3 my-4 bg-white">
              ...
              <div key={index}>
                <div className="form-group row">
                  ...
                  <div className="col-md-5">
                    {godHelpMe}
                    {/* {wantItemSubCate} */}
                    {/* <Select options={godhelpme} className="fs-5" name="wantSubCate" onChange={(event) => selectedSub(index , event)} placeholder="กรุณาเลือก Category หลักก่อน" />; */}
                  </div>
                </div>
                <div className="form-group row">
                  <label className="col-md-2 col-form-label fs-5">
            ...
            <div className="d-flex justify-content-center">
              <SolidButton width="100px" buttonColor="limegreen">
                <input
                  type="submit"
                  value="Submit"
