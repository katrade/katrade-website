...
export default function AddItem() {
  ...
  function selectedSub(index: any, event: any) {
    ...
    values[index]["reqCat"]["childCategoryTh"] =
      SubCateLangTh[0][wantSubCateIndex][event.indexC];
    SetWantInputFields(values);
  }
        ...
        <form onSubmit={handleUnload}>
          <div className="p-3 my-4 bg-white">
            ...
            <div className="form-group row">
              ...
              <div className="col-md-5">{myItemSubCate}</div>
            </div>
            <div className="form-group row">
            ...
            {wantInputFields.map((inputField: any, index: any) => (
              <div key={index}>
                ...
                <div className="d-flex justify-content-center mb-3">
                  <div
                    className={
                      countWantCate == 1 ? "d-none" : "bg-warning pointer"
                    }
                    onClick={() => {
                      handleRemoveItem(index);
                      setCountWantCate(countWantCate - 1);
                    }}
                  >
            ...
            <div
              className={countWantCate >= 5 ? "d-none" : "bg-info me-4 pointer"}
              onClick={() => {
                handleAddItem();
                setCountWantCate(countWantCate + 1);
              }}
