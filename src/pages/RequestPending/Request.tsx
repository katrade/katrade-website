          ...
          <Block height="500px">
            ...
            >
              <div className="mb-3 d-flex flex-row topic-request">
                <P
                  className={
                    component == 1 ? "p-1 fs-4 currenttap" : "p-1 fs-4"
                  }
                ...
                <P
                  className={
                    component == 2 ? "p-1 fs-4 currenttap" : "p-1 fs-4"
                  }
                  onClick={() => handleComponent(2)}
                >
                  Pending
                </P>
                <P
                  className={
                    component == 3 ? "p-1 fs-4 currenttap" : "p-1 fs-4"
                  }
                  onClick={() => handleComponent(3)}
                >
                  In progress
                </P>
              </div>
              <div style={{ minHeight: "350px" }}>{selectComponent}</div>
            </Div>
          </Block>
          <Footer />
        </div>
