...
const th = ["ภาษา", "เลือกภาษาที่คุณต้องการ"];
const en = ["Language", "Select your preferred language"];
const meow = ["meOOO", "meow meow meow meow mee muu"];
...
function Lang({ name, value, symbol, active }: ILang) {
  ...
  return (
    <Container
      style={{
        border: active ? "solid 2px #0022bd" : "solid 2px transparent",
        backgroundColor: theme === "light" ? "#fff" : "#1c1c1c",
      }}
      onClick={() => setLangCookie(value)}
    >
      <div className="text-center">
        <div
          className="m-0 p-0 noselect"
          style={{
            color: theme === "light" ? "#0022bd" : "#fff",
            fontWeight: 600,
            fontSize: "300%",
            height: "fit-content",
          }}
