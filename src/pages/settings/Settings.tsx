    ...
    <Background>
      ...
      <Block height="100vh" className="my-5">
        ...
        <div className="row my-4 m-0 p-0" style={{ minHeight: "500px" }}>
          ...
          <div
            className="col-lg-9 px-4 py-3"
            style={{ backgroundColor: "rgba(100,100,100,0.04)" }}
          >
            {selectedComponent}
          </div>
        </div>
...
const List = styled.div`
  background-color: ${(props: IList) =>
    props.active ? "rgba(0,0,0,0.03)" : "transparent"};
  width: 100%;
  height: 50px;
  ...
  &:hover {
    cursor: pointer;
    background-color: ${(props: IList) =>
      props.active ? "rgba(0,0,0,0.03)" : "rgba(0,0,0,0.013)"};
  }
`;
