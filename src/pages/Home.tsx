...
import {
  TransparentButton,
  DynamicSolidButton,
  DynamicTransparentButton,
} from "../components/standard/Button";
...
const en = [
  "Trade your items with others",
  "Exchange your items to whatever you want, to whoever need your things.",
  "Market >",
  "Sign in",
  "Start Katrade",
  "Create an account and join our KU community.",
  "Sign up",
  "Live chat with your duo",
  "Stay connect with your trade duo and make the conversation easier.",
  "Make KU community better",
  "New way to interact with other KU students. Make new friends, and let our KU community larger.",
  "Ready for trading?",
  "Visit our market and find some perfectly matched items for yourself.",
];
const th = [
  "แลกเปลี่ยนของของคุณกับของที่ใช่",
  "นำของที่คุณอยากจะแลกเปลี่ยนมาแลกกับของที่คุณอยากได้ที่นี่",
  "ตลาด >",
  "เข้าสู่ระบบ",
  "มาเริ่มเทรดกัน",
  "สร้างบัญชีผู้ใช้ของ คาเทรด แล้วมาร่วมเทรดกับชุมชน KU กันเถอะ",
  "สมัคร",
  "แชทกับคู่เทรด",
  "คุณสามารถติดต่อสื่อสารกับคู่เทรดของคุณผ่านระบบแชทของ คาเทรด",
  "สร้างสังคม KU ให้ยิ่งใหญ่",
  "กิจกรรมรูปแบบใหม่ที่จะทำให้สังคมมหาวิทยาลัยเกษตรศาสตร์ของเราพัฒนาไปอีกระดับ",
  "พร้อมเทรดหรือยัง?",
  "ไปที่ตลาดของเราแล้วหาสิ่งที่เหมาะกับคุณดูสิ",
];
            ...
            <div className="col-lg d-flex align-items-center">
              <div className="center-content-screen">
                ...
                <div className="d-flex justify-content-center">
                  ...
                  <DynamicSolidButton width="140px" onClick={LinkSignIn}>
                    {activeLang[3]}
                  </DynamicSolidButton>
                </div>
              </div>
          ...
          <div className="row m-0 py-5 full-width">
            ...
            <div className="col-lg d-flex align-items-center">
              <div className="center-content-screen">
                <H3>{activeLang[4]}</H3>
                <P>{activeLang[5]}</P>
                <DynamicSolidButton width="140px" onClick={LinkRegister}>
                  {activeLang[6]}
                </DynamicSolidButton>
              </div>
            </div>
        ...
        <Block height="300">
          <div className="m-3 pt-5 ta-center">
            <div>
              ...
              <button
                type="button"
                className="mybutton mr-3 pl-5 pr-5 mt-4"
                onClick={LinkMarket}
              >
                {activeLang[2]}
              </button>
