...
const en: string[] = ["More articles", "Why Katrade", "About us", "Contact us", "Trading policies and advices", "Terms", "Privacy"]
const th: string[] = ["บทความอื่นๆ", "ทำไมต้อง Katrade", "เกี่ยวกับเรา", "ติดต่อเรา", "ข้อตกลงการเทรดและคำแนะนำ", "ข้อตกลงการใช้งาน", "ความเป็นส่วนตัว"]
                    ...
                    <div className="full-width maxwidth100">
                        <div className="row my-5 mx-2 full-width">
                            ...
                            <div className="col-lg-4 m-0 p-3">
                                ...
                                <a href="/" className="article-link">{content[6]}</a><br />
                            </div>
                        </div>
                    </div>
                </Block>
