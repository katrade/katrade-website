...
export function uploadItemPicture(_id: string, pictures: File[]): Promise<string[]> {
    return new Promise((resolve, reject) => {
        ...
        for (var i = 0; i < pictures.length; i++) {
            ...
            output.push(`https://firebasestorage.googleapis.com/v0/b/letskatrade.appspot.com/o/items%2F${fileName}?alt=media`);
